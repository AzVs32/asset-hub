...
fn plugin_diagnostic_codes_map_to_stable_http_statuses() {
    assert_eq!(
        plugin_status(asset_plugin_sdk::protocol::diagnostic::codes::INVALID_INPUT),
        StatusCode::BAD_REQUEST
    );
    assert_eq!(
        plugin_status(asset_plugin_sdk::protocol::diagnostic::codes::PERMISSION_DENIED),
        StatusCode::FORBIDDEN
    );
    assert_eq!(
        plugin_status(asset_plugin_sdk::protocol::diagnostic::codes::CONTENT_LIMIT_EXCEEDED),
        StatusCode::PAYLOAD_TOO_LARGE
    );
    assert_eq!(
        plugin_status(asset_plugin_sdk::protocol::diagnostic::codes::TIMEOUT),
