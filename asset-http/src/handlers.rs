use crate::dto::{
    BinaryContent, CreateDirectoryRequest, CreateResourceQuery, DirectoryActionOutputResponse,
...
use asset_core::domain::{AccessContext, DirectoryId, DirectoryKind, ResourceId, ResourceKind};
