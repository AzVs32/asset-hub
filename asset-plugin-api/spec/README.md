...
This directory is the committed, language-neutral distribution of Manifest v5 and Plugin API v3.
Do not edit generated JSON files by hand.

- `contract-v3.json` is the discovery catalog for versions, capability IDs, aggregate-specific
...
- `*-v3.schema.json` files define Action, ABI JSON, and Browser Frame wire documents.

All JSON schemas use JSON Schema Draft 2020-12 and reject unknown object properties. Extism ABI
function parameters and results are described by `contract-v3.json`; JSON-valued arguments and
