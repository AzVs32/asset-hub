...
impl SecurityAuditEventType {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::MaintenanceStorageScan => "maintenance.storage_scan",
    ...
    pub fn from_stable_str(value: &str) -> Option<Self> {
        match value {
            ...
            "maintenance.storage_scan" => Some(Self::MaintenanceStorageScan),
...
mod tests {
    ...
    fn event_types_roundtrip_through_stable_storage_names() {
        let event_types = [
            ...
            SecurityAuditEventType::MaintenanceStorageScan,
